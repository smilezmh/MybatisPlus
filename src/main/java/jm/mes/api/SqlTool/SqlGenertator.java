/**
 * 基本的代码生成工具在3.0.3版本提供，但是3.0.7以上版本支持自定义Sql
 */

package jm.mes.api.SqlTool;
...
public class SqlGenertator {
    public static void Generator(String[] tableName) {
        ...
        dsc.setDbType(DbType.MYSQL)
                .setUrl("jdbc:mysql://localhost:3306/world?serverTimezone=UTC&characterEncoding=utf-8")
        ...
        pc.setParent("jm.mes.api")//配置父包路径
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/api/src/main/resources/mapper/" + pc.getModuleName()
    ...
    public static void main(String[] args) {
        Generator(new String[]{"countrylanguage"});
    }
}
