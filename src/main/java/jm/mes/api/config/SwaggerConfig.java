...
public class SwaggerConfig {
    ...
    public Docket newsApi() {
        ...
        docket.apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("jm.mes.api.base.controller"))
                .paths(PathSelectors.any()).build();
        return docket;
    }

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("smilezmh的项目").description("在这里你可以浏览项目所有接口，并提供相关测试工具")
